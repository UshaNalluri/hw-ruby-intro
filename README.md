...
If you would like to use Docker natively, please see the instructions here in Canvas, Modules, Guides and Cheatsheets, Docker. There is a quick tutorial of how to use Docker on Canvas there as well.
